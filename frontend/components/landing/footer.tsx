    ...
    <footer className="relative overflow-hidden bg-[#12100E] text-white pt-20 pb-12 border-t border-white/10">
      ...
      <div className="container-page relative z-10">
          ...
          <div className="lg:col-span-6 space-y-6">
            <Link href="/" className="inline-flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] uppercase tracking-[0.3em] text-primary -mt-1 font-sans font-semibold">Velvet Brew</span>
              </div>
            </Link>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/50">
          <p>&copy; {new Date().getFullYear()} Velvra (Velvet Brew Co.). {t.footer.copyright}</p>
